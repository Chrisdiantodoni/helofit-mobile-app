  ...
  return (
    <View style={styles.container}>
      ...
      <View
        ...
        <Text style={[styles.heading14, {color: '#FFFFFF', fontSize: 20}]}>
          Rp. 40.000
        </Text>
        <TouchableOpacity
          style={{
          ...
          onPress={() => console.log(selectedBooking, isSelected)}>
          <Text style={[styles.heading14, {color: '#000000'}]}>Reservasi</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
